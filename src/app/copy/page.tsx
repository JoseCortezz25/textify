      ...
      <div className="left-column">
        ...
        <div className="group-field">
          ...
          <Select onValueChange={(value: TONES) => setTone(value)}>
            ...
            <SelectContent>
              <SelectItem value={TONES.PROFESSIONAL} className="cursor-pointer">
              ...
              <SelectItem value={TONES.ENTHUSIASTIC} className="cursor-pointer">
                <div className="flex space-x-3 items-center py-2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
              ...
              <SelectItem value={TONES.INFORMATIVE} className="cursor-pointer">
                <div className="flex space-x-3 items-center py-2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
              ...
              <SelectItem value={TONES.FUNNY} className="cursor-pointer">
                <div className="flex space-x-3 items-center py-2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
              ...
              <SelectItem value={TONES.INFORMAL} className="cursor-pointer">
                <div className="flex space-x-3 items-center py-2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
